class Geoobj {
  ...
  Geoobj.fromJson(Map<String, dynamic> json) {
    ...
    this.plusCode = json['plus_code'] != null
        ? PlusCodeBean.fromJson(json['plus_code'])
        : null;
...
class ResultsListBean {
  ...
  ResultsListBean.fromJson(Map<String, dynamic> json) {
    ...
    this.geometry = json['geometry'] != null
        ? GeometryBean.fromJson(json['geometry'])
        : null;
    this.plusCode = json['plus_code'] != null
        ? PlusCodeBean.fromJson(json['plus_code'])
        : null;
    this.addressComponents = (json['address_components'] as List) != null
        ? (json['address_components'] as List)
            .map((i) => AddressComponentsListBean.fromJson(i))
            .toList()
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['address_components'] = this.addressComponents != null
        ? this.addressComponents.map((i) => i.toJson()).toList()
        : null;
...
class GeometryBean {
  ...
  GeometryBean.fromJson(Map<String, dynamic> json) {
    ...
    this.location = json['location'] != null
        ...
        : null;
    this.viewport = json['viewport'] != null
        ? ViewportBean.fromJson(json['viewport'])
        : null;
  }
...
class ViewportBean {
  ...
  ViewportBean.fromJson(Map<String, dynamic> json) {
    this.northeast = json['northeast'] != null
        ? NortheastBean.fromJson(json['northeast'])
        : null;
    this.southwest = json['southwest'] != null
        ? SouthwestBean.fromJson(json['southwest'])
        : null;
  }
